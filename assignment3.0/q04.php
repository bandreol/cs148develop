...
$query = 'SELECT pmkStudentId, fldLastName, fldFirstName FROM tblStudents, tblEnrolls, tblCourses '
        . 'WHERE pmkStudentId = fnkStudentId '
        . 'AND pmkCourseId = fnkCourseId '
        . 'AND fldCourseName = "Database Design for the Web" ';
...
//    }
    ...
    print '<thead>';
    print '<tr class="even">';
    print '<th class="teacherTh">pmkStudentId</th>';
